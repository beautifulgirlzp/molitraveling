myapp.controller('index_ctr', ['$scope', '$http', '$rootScope', function($scope, $http, $rootScope) {
    setCss();
    ...
    $window.on('mousewheel.a DOMMouseScroll.a', function(e) {
        ...
        if ((endTime - startTime) < -500) {
            ...
            switch (flag) {
                case 0:
                    $body.stop(true, true).animate({ 'scrollTop': scorllY });
    ...
    $rootScope.$on('$stateChangeStart', function() {
        $(window).off('mousewheel.a');
        $(window).off('DOMMouseScroll.a');
